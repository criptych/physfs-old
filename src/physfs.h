 ...
 *   \param priority Relative priority of the archive; higher values place the
 *                   archive later in the search path.  For backward
 *                   compatibility, zero always prepends the archive; negative
 *                   values always append.
 ...
 *                     will be "mounted", in platform-independent notation.
 *                     NULL or "" is equivalent to "/".
 *   \param priority Relative priority of the archive; see PHYSFS_mount.
